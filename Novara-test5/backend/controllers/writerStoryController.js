  ...
  try {
    ...
    const updated = await prisma.chapter.update({
      ...
      data: {
        ...
        content: req.body.content === undefined ? undefined : String(req.body.content).trim(),
        chapterNumber:
          req.body.chapterNumber === undefined ? undefined : Number(req.body.chapterNumber),
        isPublished:
          req.body.isPublished === undefined ? undefined : Boolean(req.body.isPublished),
      },
    });
