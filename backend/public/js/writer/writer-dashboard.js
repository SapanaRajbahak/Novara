  ...
  return `
    <section class="writer-stories">
      ...
      <div class="stories-create-row">
        <a class="btn btn-primary" href="/writer/writer-stories-new.html">Create Book</a>
      </div>
    ...
    <section class="writer-home">
      <div class="home-welcome-card">
        ...
        <div class="home-welcome-actions">
          <button class="btn btn-primary" onclick="window.location.href = '/writer/writer-stories-new.html'">Create New Story</button>
          <button class="btn btn-secondary" onclick="switchSection('stories')">New Chapter</button>
          <button class="btn btn-soft" onclick="window.location.href = '/reader/profile.html'">Preview Author Profile</button>
        </div>
      </div>
    </section>
  `;
